                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title mt-3">Bảng Đánh Giá</h3>
                            </div>
                            <!-- /.card-header -->
...
export default {
    ...
    methods: {
        ...
        selectAll(checked) {
            this.selected = checked ? this.reviews.map((item) => item.id) : [];
        ...
        selectOne(checked) {
            ...
            this.allSelected = this.selected.length === this.reviews.length;
        },
        deleteMutiple() {
            this.$swal({
                title: "Bạn chắc chắn muốn xóa?",
                ...
                .then(async (result) => {
                    if (result.isConfirmed) {
                        axios
                            .delete("/api/reviews/" + this.selected)
                            .then((response) => {
                                this.getReviews();
                                this.$swal({
                                    title: "Đã xóa!",
        ...
        handleStatus(status) {
            axios
                .put("/api/reviews/" + this.selected[0], {
                    ids: this.selected,
                    status: status,
                })
                .then((response) => {
